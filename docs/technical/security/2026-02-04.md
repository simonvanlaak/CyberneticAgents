...
- [x] Require `agent_id` for all CLI tool executions or enforce safe default.
- [x] Add durable security audit log storage (or explicitly de-scope `data/security_logs.db`).
- [x] Pin CLI tools Docker base image by digest.
