...
from src.cyberagent.authz.authz_db import resolve_authz_db_url
from src.cyberagent.authz.policy_bootstrap import ensure_policy_bootstrap
...
def get_enforcer():
    ...
    if _global_enforcer is None:
        ...
        ensure_policy_bootstrap(_global_enforcer, scope="tools")
