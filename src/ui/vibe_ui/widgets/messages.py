...
except ImportError:  # Textual 0.62 fallback
    MarkdownStream = None  # type: ignore[assignment]

from src.ui.vibe_ui.widgets.no_markup_static import NoMarkupStatic
from src.ui.vibe_ui.widgets.spinner import SpinnerMixin, SpinnerType
...
class BaseMarkdownStream:
    async def write(self, content: str) -> None: ...

    async def stop(self) -> None: ...


class _FallbackMarkdownStream(BaseMarkdownStream):
    ...
    async def write(self, content: str) -> None:
        ...
        await self._markdown.update(self._buffer)
...
class StreamingMessageBase(Static):
    def __init__(self, content: str) -> None:
        ...
        self._stream: BaseMarkdownStream | None = None
